globals [
  ...
  is-spread-to-westbound   ;; at least one red patch at max-pxcor
]
...
to setup
  ...
  ;; apply felling strategy
  (ifelse
    ;; apply Y-lines strategy
    felling-strategy = "Y-lines" [
      ;; generate centroid random points of felling
      while [i < count-of-felling-points] [
        let x random-xcor

        ;; apply felling with some probability
        ask patches with [(pxcor < (x + width-of-felling)) and (pxcor > (x))] [
          if (random 100) < probability-of-felling [
            set pcolor black
          ]
        ]
    ...
    ;; apply X-lines strategy
    felling-strategy = "X-lines" [
      ;; generate centroid random points of felling
      while [i < count-of-felling-points] [
        let y random-ycor

        ;; apply felling with some probability
        ask patches with [(pycor < (y + width-of-felling)) and (pycor > (y))] [
          if (random 100) < probability-of-felling [
            set pcolor black
          ]
        ]
    ...
    ;; apply XY-lines strategy
    felling-strategy = "XY-lines" [
      ;; generate centroid random points of felling
      while [i < count-of-felling-points] [
        let x random-xcor
        let y random-ycor
    ...
    ;; apply Square strategy
    felling-strategy = "Square" [
      ;; generate centroid random points of felling
      while [i < count-of-felling-points] [
        let x random-xcor
        let y random-ycor
        ...
        ;; apply felling with some probability
        ask patches with [(pxcor < (x + (2 * width-of-felling))) and (pxcor > (x - (2 * width-of-felling))) and (pycor < (y + (2 * width-of-felling))) and (pycor > (y - (2 * width-of-felling)))] [
          if (random 100) < probability-of-felling [
            set pcolor black
          ]
        ]
  ...
  set is-spread-to-westbound false
  reset-ticks
end

to go
  ;; count red pathcer at max-pxcor
  let cnt-shade-red count patches with [(shade-of? pcolor red) and ((pxcor = max-pxcor))]
  if cnt-shade-red > 0 [set is-spread-to-westbound true]
...
felling-strategy
felling-strategy
"Default" "X-lines" "Y-lines" "XY-lines" "Square"
4
...
@#$#@#$#@
<experiments>
  <experiment name="probability-spread-to-westbound" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>is-spread-to-westbound</metric>
  ...
  <experiment name="dependency-between-parameters" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="probability-of-felling">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="count-of-felling-points">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="probability-of-spread">
      <value value="75"/>
    ...
    <enumeratedValueSet variable="width-of-felling">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="south-wind-speed">
      <value value="-20"/>
    ...
    <enumeratedValueSet variable="felling-strategy">
      <value value="&quot;Default&quot;"/>
      <value value="&quot;X-lines&quot;"/>
      <value value="&quot;Y-lines&quot;"/>
      <value value="&quot;XY-lines&quot;"/>
      <value value="&quot;Square&quot;"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
